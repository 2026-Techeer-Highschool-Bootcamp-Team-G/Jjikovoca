...
// 프로토타입 12-4 수학 복습 — 판정 정답 (79:598)과 동일. 정답 판정 결과를 고정 렌더.
...
/** 12-4 수학 복습 — 판정 정답 (F-26) — 정답 판정 결과 화면 */
export function MathVerdictCorrectPage() {
  const navigate = useNavigate()
  const handleGrade = (_grade: Grade) => navigate(-1)
  // 판정 결과(정답·해설)는 MathAnswerPage 판정 응답에서 전달받음. 없으면 데모 폴백
  ...
  return (
    <div style={pageStyle}>
      ...
      >
        ...
        <VerdictView correct answerValue={answerValue} explanation={explanation} enteredAnswer={enteredAnswer} />
