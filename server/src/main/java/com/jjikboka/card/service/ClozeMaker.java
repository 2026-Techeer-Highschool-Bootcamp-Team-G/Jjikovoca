...
public final class ClozeMaker {
    ...
    public record Cloze(String clozeText, String blankToken, List<String> hints) {
    }

    public static Cloze make(String word, String example, String meaning) {
    ...
    public static boolean judge(String word, String guess) {
        if (guess == null) {
            return false;
        }
