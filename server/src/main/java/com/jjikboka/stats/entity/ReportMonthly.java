...
public class ReportMonthly {
    ...
    public static ReportMonthly of(Long userId, String period) {
    ...
    public void apply(int newCards, int studyCount, BigDecimal accuracyWord, BigDecimal accuracyProblem,
